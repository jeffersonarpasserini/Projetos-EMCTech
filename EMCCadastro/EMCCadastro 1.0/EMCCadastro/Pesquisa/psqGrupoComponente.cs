...
{
    public partial class psqGrupoComponente : Form
    {
        ...
        public psqGrupoComponente()
        {
            InitializeComponent();
        }

        public psqGrupoComponente(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdCusto_ComponenteGrupo_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdCusto_ComponenteGrupo.Rows[grdCusto_ComponenteGrupo.CurrentRow.Index].Cells["idcusto_componentegrupo"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
              try
            {
                Custo_ComponenteGrupoRN oComponenteGrupoRN = new Custo_ComponenteGrupoRN(Conexao, oOcorrencia,codempresa);

                DataTable dtCon = oComponenteGrupoRN.pesquisaComponenteGrupo(empMaster, EmcResources.cInt(txtidCusto_ComponenteGrupo.Text), txtDescricao.Text);


                grdCusto_ComponenteGrupo.DataSource = dtCon;
        ...
        private void psqGrupoComponente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqGrupoComponente_Load(object sender, EventArgs e)
        {
