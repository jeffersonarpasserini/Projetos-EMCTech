...
{
    public partial class psqIndexador : Form
    {
       private String usuario = "";
        ...
        public psqIndexador(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                IndexadorRN oIndexadorRN = new IndexadorRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oIndexadorRN.pesquisaIndexador(empMaster, EmcResources.cInt(txtIdIndexador.Text), txtIndexador.Text);

                grdPsqIndexador.DataSource = dtCon;
        ...
        private void grdPsqIndexador_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqIndexador.Rows[grdPsqIndexador.CurrentRow.Index].Cells["idindexador"].Value.ToString());
            this.Close();
        }

        private void psqIndexador_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqIndexador_Load(object sender, EventArgs e)
        {
