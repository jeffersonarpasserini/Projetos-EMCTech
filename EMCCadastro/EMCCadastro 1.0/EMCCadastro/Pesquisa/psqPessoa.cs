...
{
    public partial class psqPessoa : Form
    {
        ...
        public psqPessoa(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                PessoaRN oPessoaRN = new PessoaRN(Conexao, oOcorrencia,codempresa);

                DataTable dtCon = oPessoaRN.pesquisaPessoa(empMaster, EmcResources.cInt(txtIdPessoa.Text), txtPessoa.Text, txtCNPJCPF.Text);
        ...
        private void grdPsqCtaReceber_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaReceber.Rows[grdPsqCtaReceber.CurrentRow.Index].Cells["idpessoa"].Value.ToString());
            retPesquisa.chavebusca = grdPsqCtaReceber.Rows[grdPsqCtaReceber.CurrentRow.Index].Cells["cnpjcpf"].Value.ToString();
            this.Close();
        ...
        private void psqPessoa_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqPessoa_Load(object sender, EventArgs e)
        {
