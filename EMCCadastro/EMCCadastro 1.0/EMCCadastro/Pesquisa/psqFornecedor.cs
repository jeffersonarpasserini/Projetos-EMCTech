...
{
    public partial class psqFornecedor : Form
    {
        ...
        public psqFornecedor()
        {
            InitializeComponent();
        }

        public psqFornecedor(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia )
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtCon = oFornecedorRN.pesquisaFornecedor(empMaster, EmcResources.cInt(txtIdFornecedor.Text), txtFornecedor.Text, txtCNPJCPF.Text);
        ...
        private void grdPsqCtaPagar_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaPagar.Rows[grdPsqCtaPagar.CurrentRow.Index].Cells["idpessoa"].Value.ToString());
            retPesquisa.chavebusca = grdPsqCtaPagar.Rows[grdPsqCtaPagar.CurrentRow.Index].Cells["cnpjcpf"].Value.ToString();
            this.Close();
        }
        ...
        private void psqFornecedor_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqFornecedor_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtFornecedor;
