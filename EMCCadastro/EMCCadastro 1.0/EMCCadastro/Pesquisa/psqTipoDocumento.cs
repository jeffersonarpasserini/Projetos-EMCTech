...
{
    public partial class psqTipoDocumento : Form
    {
        ...
        public psqTipoDocumento()
        {
            InitializeComponent();
        }
        
        public psqTipoDocumento(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                TipoDocumentoRN oTipoDocumentoRN = new TipoDocumentoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oTipoDocumentoRN.pesquisaTipoDocumento(empMaster, EmcResources.cInt(txtIdTipoDocumento.Text), txtDescricao.Text, txtAbreviatura.Text);

                grdPsqTipoDocumento.DataSource = dtCon;
        ...
        private void grdPsqTipoDocumento_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqTipoDocumento.Rows[grdPsqTipoDocumento.CurrentRow.Index].Cells["idTipoDocumento"].Value.ToString());
            this.Close();
        }

        private void psqTipoDocumento_Load(object sender, EventArgs e)
        {
        ...
        private void psqTipoDocumento_KeyDown(object sender, KeyEventArgs e)
        {
