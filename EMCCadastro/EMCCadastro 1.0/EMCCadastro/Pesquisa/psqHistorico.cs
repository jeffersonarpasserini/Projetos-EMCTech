...
{
    public partial class psqHistorico : Form
    {
        ...
        public psqHistorico(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
             HistoricoRN oHistoricoRN = new HistoricoRN(Conexao, oOcorrencia, codempresa);

             DataTable dtCon;

                
              if(cboExigeComplemento.Text == "")
               {
                 dtCon = oHistoricoRN.pesquisaHistorico(empMaster, EmcResources.cInt(txtIdHistorico.Text), txtDescricao.Text, cboExigeComplemento.Text);
                 grdpsqHistorico.DataSource = dtCon;
               }

               if (cboExigeComplemento.SelectedValue != null)
               {
                   dtCon = oHistoricoRN.pesquisaHistorico(empMaster, EmcResources.cInt(txtIdHistorico.Text), txtDescricao.Text, cboExigeComplemento.SelectedValue.ToString());
                   grdpsqHistorico.DataSource = dtCon;
               }
            }
        ...
        private void psqHistorico_KeyDown(object sender, KeyEventArgs e)
       {
        ...
        private void psqHistorico_Load(object sender, EventArgs e)
        {
        ...
        private void psqgrdHistorico_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdpsqHistorico.Rows[grdpsqHistorico.CurrentRow.Index].Cells["idHistorico"].Value.ToString());
            this.Close();
        }
