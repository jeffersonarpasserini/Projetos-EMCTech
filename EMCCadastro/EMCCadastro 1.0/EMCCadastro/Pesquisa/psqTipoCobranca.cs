...
{
    public partial class psqTipoCobranca : Form
    {
        ...
        public psqTipoCobranca()
        {
            InitializeComponent();
        }

        public psqTipoCobranca(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                TipoCobrancaRN oTipoCobrancaRN = new TipoCobrancaRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oTipoCobrancaRN.pesquisaTipoCobranca(empMaster, EmcResources.cInt(txtIdTipoCobranca.Text), txtDescricao.Text);

                grdPsqTipoCobranca.DataSource = dtCon;
        ...
        private void psqTipoCobranca_Load(object sender, EventArgs e)
        {
        ...
        private void grdPsqTipoCobranca_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqTipoCobranca.Rows[grdPsqTipoCobranca.CurrentRow.Index].Cells["idTipoCobranca"].Value.ToString());
            this.Close();
        }
        ...
        private void psqTipoCobranca_KeyDown(object sender, KeyEventArgs e)
        {
