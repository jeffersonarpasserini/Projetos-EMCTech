...
{
    public partial class psqCustoComponente : Form
    {
        ...
        public psqCustoComponente()
        {
            InitializeComponent();
        }

        public psqCustoComponente(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdCusto_Componente_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdCusto_Componente.Rows[grdCusto_Componente.CurrentRow.Index].Cells["idcusto_componente"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Custo_ComponenteRN oComponenteRN = new Custo_ComponenteRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oComponenteRN.pesquisaComponente(empMaster, EmcResources.cInt(txtidCusto_Componente.Text), txtDescricao.Text);


                grdCusto_Componente.DataSource = dtCon;
        ...
        private void psqCustoComponente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqCustoComponente_Load(object sender, EventArgs e)
        {
