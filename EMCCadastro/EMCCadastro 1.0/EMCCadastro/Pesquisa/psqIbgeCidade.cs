...
{
    public partial class psqIbgeCidade : Form
    {
        ...
        public psqIbgeCidade()
        {
            InitializeComponent();
        }

        public psqIbgeCidade(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                IbgeCidadeRN oIbgeCidadeRN = new IbgeCidadeRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oIbgeCidadeRN.pesquisaIbgeCidade(empMaster, EmcResources.cInt(txtCodigoIbge.Text), txtNomeCidade.Text, cboEstado.Text);


                grdPsqIbgeCidade.DataSource = dtCon;
        ...
        private void grdPsqIbgeCidade_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqIbgeCidade.Rows[grdPsqIbgeCidade.CurrentRow.Index].Cells["codigoibge"].Value.ToString());
            this.Close();
        }
        ...
        private void psqIbgeCidade_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqIbgeCidade_Load(object sender, EventArgs e)
        {
