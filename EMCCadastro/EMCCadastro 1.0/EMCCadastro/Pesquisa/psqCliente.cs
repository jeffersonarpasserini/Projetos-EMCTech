...
{
    public partial class psqCliente : Form
    {
        ...
        public psqCliente(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtCon = oClienteRN.pesquisaCliente(empMaster, EmcResources.cInt(txtIdCliente.Text), txtCliente.Text, txtCNPJCPF.Text);
        ...
        private void psqCliente_KeyDown(object sender, KeyEventArgs e)
        {
