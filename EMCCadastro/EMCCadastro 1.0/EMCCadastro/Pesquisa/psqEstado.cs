...
{
    public partial class psqEstado : Form
    {
        ...
        public psqEstado(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdPsqEstado_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqEstado.Rows[grdPsqEstado.CurrentRow.Index].Cells["idestado"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                EstadoRN oEstadoRN = new EstadoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstadoRN.pesquisaEstado(empMaster, EmcResources.cInt(txtIdEstado.Text), txtDescricao.Text, txtAbreviatura.Text);
                
                grdPsqEstado.DataSource = dtCon;
        ...
        private void psqEstado_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqEstado_Load(object sender, EventArgs e)
        {
