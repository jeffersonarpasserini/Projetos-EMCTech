...
{
    public partial class psqCep : Form
    {
        ...
        public psqCep(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                CepRN oCepRN = new CepRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oCepRN.pesquisaCep(empMaster, EmcResources.cInt(txtIdCep.Text), txtCidade.Text, cboEstado.Text, ckEstado.Checked);


                grdPsqCep.DataSource = dtCon;
        ...
        private void grdPsqCep_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCep.Rows[grdPsqCep.CurrentRow.Index].Cells["idcep"].Value.ToString());
            this.Close();
        }

        private void psqCep_Load(object sender, EventArgs e)
        {
        ...
        private void psqCep_KeyDown(object sender, KeyEventArgs e)
        {
