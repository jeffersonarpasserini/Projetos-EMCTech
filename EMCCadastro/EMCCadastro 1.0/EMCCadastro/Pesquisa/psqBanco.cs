...
{
    public partial class psqBanco : Form
    {
        ...
        public psqBanco(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtCon = oBancoRN.pesquisaBanco(empMaster, EmcResources.cInt(txtIdBanco.Text), txtBanco.Text);
        ...
        private void grdPsqCtaReceber_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaReceber.Rows[grdPsqCtaReceber.CurrentRow.Index].Cells["idbanco"].Value.ToString());
            this.Close();
        }
        ...
        private void psqBanco_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqBanco_Load(object sender, EventArgs e)
        {
