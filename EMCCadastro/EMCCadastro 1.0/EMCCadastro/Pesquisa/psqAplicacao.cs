...
{
    public partial class psqAplicacao : Form
    {
        ...
        public psqAplicacao(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                AplicacaoRN oAplRN = new AplicacaoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oAplRN.pesquisaAplicacao(empMaster, EmcResources.cInt(txtIdAplicacao.Text), txtAplicacao.Text);
        ...
        private void grdPsqCtaReceber_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaReceber.Rows[grdPsqCtaReceber.CurrentRow.Index].Cells["idaplicacao"].Value.ToString());
            this.Close();
        }
        ...
        private void psqAplicacao_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqAplicacao_Load(object sender, EventArgs e)
        {
