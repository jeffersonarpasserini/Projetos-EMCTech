...
{
    public partial class psqFormaPagamento : Form
    {
        ...
        public psqFormaPagamento()

        {
            InitializeComponent();
        }

        public psqFormaPagamento(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                FormaPagamentoRN oFormaPagamentoRN = new FormaPagamentoRN (Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oFormaPagamentoRN.pesquisaFormaPagamento(empMaster, EmcResources.cInt(txtIdFormaPagamento.Text), txtDescricao.Text);

                grdPsqFormaPagamento.DataSource = dtCon;
        ...
        private void grdPsqFormaPagamento_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqFormaPagamento.Rows[grdPsqFormaPagamento.CurrentRow.Index].Cells["idformapagamento"].Value.ToString());
            this.Close();
                        
        }

        private void psqFormaPagamento_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqFormaPagamento_Load(object sender, EventArgs e)
        {
