...
{
    public partial class psqHolding : Form
    {
        ...
        public psqHolding(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                HoldingRN oHoldingRN = new HoldingRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oHoldingRN.pesquisaHolding(empMaster, EmcResources.cInt(txtIdHolding.Text), txtNomeHolding.Text);

                grdPsqHolding.DataSource = dtCon;
        ...
        private void grdPsqHolding_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqHolding.Rows[grdPsqHolding.CurrentRow.Index].Cells["idholding"].Value.ToString());
            this.Close();
        }

        private void psqHolding_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqHolding_Load(object sender, EventArgs e)
        {
