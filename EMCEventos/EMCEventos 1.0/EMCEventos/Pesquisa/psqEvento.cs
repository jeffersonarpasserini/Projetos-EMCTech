...
{
    public partial class psqEvento : Form
    {
        ...
        public psqEvento(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtCon = oEventoRN.pesquisaEvento(empMaster, txtCodigoImovel.Text, txtDataInicial.DateValue, txtDataFinal.DateValue);

                grdPsqEvento.DataSource = dtCon;
        ...
        private void grdPsqEvento_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqEvento.Rows[grdPsqEvento.CurrentRow.Index].Cells["idevt_evento"].Value.ToString());
        ...
        private void btnImovel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtIdEvento.Text = EMCImob.retPesquisa.chaveinterna.ToString();
        ...
        private void psqEvento_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqEvento_Load(object sender, EventArgs e)
        {
