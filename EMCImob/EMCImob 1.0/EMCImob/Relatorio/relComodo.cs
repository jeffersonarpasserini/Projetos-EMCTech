...
{
    public partial class relComodo : EMCLibrary.tplRelatorio
    {
        private const string nomeFormulario = "relComodos";
        ...
        public relComodo(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void relComodo_Load(object sender, EventArgs e)
        {
        ...
        public override void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ComodoRN oBLL = new ComodoRN(Conexao, objOcorrencia, codempresa);

                //Montando Consulta SQL para o relatório
                string drpRelatorio = DataReport();

                this.dstComodo.Tables["MyTable"].Clear();
                this.dstComodo.Tables["MyTable"].Load(oBLL.ListaComodo(drpRelatorio).CreateDataReader());

                //verifica se encontrou registros a emitir
                if (this.dstComodo.Tables["MyTable"].Rows.Count == 0)
                {
        ...
        public override void LimpaCampos()
        {
            ...
            arr.Add(new popCombo("Código do Comodo", "1"));
            arr.Add(new popCombo("Descrição do Comodo", "2"));
