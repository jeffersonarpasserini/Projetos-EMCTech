...
{
    public partial class relLocacaoProventos : EMCLibrary.tplRelatorio
    {
        private const string nomeFormulario = "relLocacaoProventos";
        ...
        public relLocacaoProventos(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void relLocacaoProventos_Load(object sender, EventArgs e)
        {
        ...
        public override void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LocacaoProventosRN oBLL = new LocacaoProventosRN(Conexao, objOcorrencia, codempresa);

                //Montando Consulta SQL para o relatório
                string drpRelatorio = DataReport();

                this.dstLocacaoProventos.Tables["MyTable"].Clear();
                this.dstLocacaoProventos.Tables["MyTable"].Load(oBLL.ListaLocacaoProventos(drpRelatorio).CreateDataReader());

                //verifica se encontrou registros a emitir
                if (this.dstLocacaoProventos.Tables["MyTable"].Rows.Count == 0)
                {
        ...
        public override void LimpaCampos()
        {
            ...
            arr.Add(new popCombo("Código do Provento", "1"));
            arr.Add(new popCombo("Descrição do Provento", "2"));
