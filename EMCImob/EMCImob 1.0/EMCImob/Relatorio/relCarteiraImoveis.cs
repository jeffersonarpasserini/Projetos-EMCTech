...
{
    public partial class relCarteiraImoveis : EMCLibrary.tplRelatorio
    {
        private const string nomeFormulario = "relCarteiraImoveis";
        ...
        public relCarteiraImoveis(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void relCarteiraImoveis_Load(object sender, EventArgs e)
        {
        ...
        public override void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CarteiraImoveisRN oBLL = new CarteiraImoveisRN(Conexao, objOcorrencia, codempresa);

                //Montando Consulta SQL para o relatório
                string drpRelatorio = DataReport();

                this.dstCarteiraImoveis.Tables["MyTable"].Clear();
                this.dstCarteiraImoveis.Tables["MyTable"].Load(oBLL.ListaCarteiraImoveis(drpRelatorio).CreateDataReader());

                //verifica se encontrou registros a emitir
                if (this.dstCarteiraImoveis.Tables["MyTable"].Rows.Count == 0)
                {
        ...
        public override void LimpaCampos()
        {
            ...
            arr.Add(new popCombo("Código da Carteira de Imóveis", "1"));
            arr.Add(new popCombo("Descrição da Carteira de Imóveis", "2"));
