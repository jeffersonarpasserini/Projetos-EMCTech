...
namespace EMCImob
{
    public partial class psqTipoImovel : Form
    {
        ...
        public psqTipoImovel()
        {
            InitializeComponent();
        }

        public psqTipoImovel(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                TipoImovelRN oTipoImRN = new TipoImovelRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oTipoImRN.pesquisaTipoImovel(empMaster, EmcResources.cInt(txtIdTipoImovel.Text), txtTipoImovel.Text);

                grdPsqTipoImovel.DataSource = dtCon;
        ...
        private void grdPsqTipoImovel_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqTipoImovel.Rows[grdPsqTipoImovel.CurrentRow.Index].Cells["idtipoimovel"].Value.ToString());
            this.Close();
        }
        ...
        private void psqTipoImovel_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqTipoImovel_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtTipoImovel;
        }
