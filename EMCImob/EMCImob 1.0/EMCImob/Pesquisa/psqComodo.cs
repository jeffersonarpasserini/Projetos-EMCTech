...
namespace EMCImob
{
    public partial class psqComodo : Form
    {
        ...
        public psqComodo(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ComodoRN oComRN = new ComodoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oComRN.pesquisaComodo(empMaster, EmcResources.cInt(txtIdComodo.Text), txtComodo.Text);

                grdPsqComodo.DataSource = dtCon;
        ...
        private void grdPsqComodo_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqComodo.Rows[grdPsqComodo.CurrentRow.Index].Cells["idcomodos"].Value.ToString());
            this.Close();
        }
        ...
        private void psqComodo_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqComodo_Load(object sender, EventArgs e)
        {
