...
namespace EMCImob
{
    public partial class psqTipoLanctoCaptacao : Form
    {
        ...
        public psqTipoLanctoCaptacao()
        {
            InitializeComponent();
        }

        public psqTipoLanctoCaptacao(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                TipoLanctoCaptacaoRN oTpLanctoCapRN = new TipoLanctoCaptacaoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oTpLanctoCapRN.pesquisaTipoLanctoCaptacao(empMaster, EmcResources.cInt(txtIdTipoLanctoCaptacao.Text), txtTipoLanctoCaptacao.Text);

                grdPsqTipoLanctoCaptacao.DataSource = dtCon;
        ...
        private void grdPsqTipoLanctoCaptacao_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqTipoLanctoCaptacao.Rows[grdPsqTipoLanctoCaptacao.CurrentRow.Index].Cells["idtipolanctocaptacao"].Value.ToString());
            this.Close();
        }
        ...
        private void psqTipoLanctoCaptacao_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqTipoLanctoCaptacao_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtTipoLanctoCaptacao;
        }
