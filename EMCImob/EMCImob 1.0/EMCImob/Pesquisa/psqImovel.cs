...
namespace EMCImob
{
    public partial class psqImovel : Form
    {
        ...
        public psqImovel(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtCon = oImovelRN.pesquisaImovel(empMaster,
                                                           EmcResources.cInt(txtIdImovel.Text), 
                                                           txtCodImovel.Text,
                                                           EmcResources.cInt(txtIdEmpresa.Text),
                                                           EmcResources.cInt(cboTipoImovel.SelectedValue.ToString()),
        ...
        private void grdPsqImovel_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqImovel.Rows[grdPsqImovel.CurrentRow.Index].Cells["idimovel"].Value.ToString());
            retPesquisa.chavebusca = grdPsqImovel.Rows[grdPsqImovel.CurrentRow.Index].Cells["codigoimovel"].Value.ToString();           
            this.Close();
        }
        ...
        private void txtidCep_Validating(object sender, CancelEventArgs e)
        {
            if (txtidCep.Text.Trim().Length == 8)
            {
                ...
                try
                {
                    CepRN cepBLL = new CepRN(Conexao, oOcorrencia, codempresa);
        ...
        {
            psqCep ofrm = new psqCep(usuario.ToString(), login.ToString(), codempresa.ToString(), empMaster.ToString(), Conexao, oOcorrencia);
            ofrm.ShowDialog();
        ...
        private void psqImovel_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqImovel_Load(object sender, EventArgs e)
        {
            TipoImovelRN oTipoImovelRN = new TipoImovelRN(Conexao, oOcorrencia, codempresa);
            ...
            CarteiraImoveisRN oCarteiraImoveisRN = new CarteiraImoveisRN(Conexao, oOcorrencia, codempresa);
            ...
            this.ActiveControl = txtCodImovel;           
        }
