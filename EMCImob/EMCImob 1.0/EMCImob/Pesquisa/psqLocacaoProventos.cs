...
namespace EMCImob
{
    public partial class psqLocacaoProventos : Form
    {
        ...
        public psqLocacaoProventos()
        {
            InitializeComponent();
        }

        public psqLocacaoProventos(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                LocacaoProventosRN oLocProvRN = new LocacaoProventosRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oLocProvRN.pesquisaLocacaoProventos(empMaster, EmcResources.cInt(txtIdLocacaoProventos.Text), txtLocacaoProventos.Text);

                grdPsqLocacaoProventos.DataSource = dtCon;
        ...
        private void grdPsqLocacaoProventos_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqLocacaoProventos.Rows[grdPsqLocacaoProventos.CurrentRow.Index].Cells["idlocacaoproventos"].Value.ToString());
            this.Close();
        }
        ...
        private void psqLocacaoProventos_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqLocacaoProventos_Load(object sender, EventArgs e)
        {
