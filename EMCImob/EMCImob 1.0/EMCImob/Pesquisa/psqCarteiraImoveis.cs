...
namespace EMCImob
{
    public partial class psqCarteiraImoveis : Form
    {
        ...
        public psqCarteiraImoveis()
        {
            InitializeComponent();
        }

        public psqCarteiraImoveis(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                CarteiraImoveisRN oCarteiraImRN = new CarteiraImoveisRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oCarteiraImRN.pesquisaCarteiraImoveis(empMaster, EmcResources.cInt(txtIdCarteiraImoveis.Text), txtCarteiraImoveis.Text);

                grdPsqCarteiraImoveis.DataSource = dtCon;
        ...
        private void grdPsqCarteiraImoveis_DoubleClick(object sender, EventArgs e)
        {

            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCarteiraImoveis.Rows[grdPsqCarteiraImoveis.CurrentRow.Index].Cells["idcarteiraimoveis"].Value.ToString());
            this.Close();
        }
        ...
        private void psqCarteiraImoveis_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqCarteiraImoveis_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtCarteiraImoveis;
        }
