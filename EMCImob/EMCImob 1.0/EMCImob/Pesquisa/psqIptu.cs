...
namespace EMCImob
{
    public partial class psqIptu : Form
    {
        ...
        public psqIptu(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                IptuRN oIptuRN = new IptuRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oIptuRN.pesquisaIptu(empMaster, txtCodigoImovel.Text, txtDataInicial.DateValue, txtDataFinal.DateValue);

                grdPsqIptu.DataSource = dtCon;
        ...
        private void grdPsqIptu_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqIptu.Rows[grdPsqIptu.CurrentRow.Index].Cells["idiptu"].Value.ToString());
            //retPesquisa.chaveinterna = EmcResources.cInt(grdPsqIptu.Rows[grdPsqIptu.CurrentRow.Index].Cells["idimovel"].Value.ToString());
            retPesquisa.chavebusca = grdPsqIptu.Rows[grdPsqIptu.CurrentRow.Index].Cells["codigoimovel"].Value.ToString();
        ...
        private void psqIptu_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqIptu_Load(object sender, EventArgs e)
        {
