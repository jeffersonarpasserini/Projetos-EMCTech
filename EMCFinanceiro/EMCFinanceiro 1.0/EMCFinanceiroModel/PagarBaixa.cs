...
namespace EMCFinanceiroModel
{
    public class PagarBaixa
    {
        public PagarBaixa() 
        {
            this.tarifaConciliada = false;
            this.agrupadoMovBancario = true;
        }

        public virtual int idPagarBaixa { get; set; }
        public virtual int codEmpresa { get; set; }
        public virtual PagarParcela pagarParcela { get; set; }
        ...
        public virtual Decimal totalCorrecao { get; set; }
        ...
        public virtual PagarBaixa idAmortizacao { get; set; }
        public virtual PagarParcela idDivida { get; set; }
        public virtual ChequeEmitir cheque { get; set; }
        /* Atributos para controle de valores indexados */
        public virtual double valorIndiceAjuste { get; set; }
        public virtual double valorBaixaIndexado { get; set; }
        /* parametro para conciliar automaticamente as tarifas bancarias */
        public virtual Boolean tarifaConciliada { get; set; }
        public virtual Boolean agrupadoMovBancario { get; set; }
