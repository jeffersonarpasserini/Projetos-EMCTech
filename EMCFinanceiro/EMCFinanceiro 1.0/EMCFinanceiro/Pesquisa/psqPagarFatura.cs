...
{
    public partial class psqPagarFatura : Form
    {
        ...
        public psqPagarFatura()
        {
            InitializeComponent();
        }

        public psqPagarFatura(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia )
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                PagarFaturaRN oPgFaturaRN = new PagarFaturaRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oPgFaturaRN.pesquisaPagarFatura(codempresa, 
                                                                    empMaster, 
        ...
        private void grdPsqCtaPagar_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.codempresa = codempresa;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaPagar.Rows[grdPsqCtaPagar.CurrentRow.Index].Cells["idpagarfatura"].Value.ToString());
