...
{
    public partial class psqAdCompensar : Form
    {
       private String usuario = "";
        ...
        public psqAdCompensar()
        {
            InitializeComponent();
        }

        public psqAdCompensar(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia )
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                PagarBaixaRN oPgBaixaRN = new PagarBaixaRN(Conexao, oOcorrencia, codempresa);
                
                DataTable dtCon = oPgBaixaRN.pesquisaBaixaCompensar(codempresa, 
                                                                        empMaster, 
        ...
        private void grdPsqCtaPagar_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.codempresa = codempresa;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaPagar.Rows[grdPsqCtaPagar.CurrentRow.Index].Cells["idpagarbaixa"].Value.ToString());
