...
{
    public partial class psqAdReceber : Form
    {
        ...
        public psqAdReceber(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                ReceberBaixaRN oRcBaixaRN = new ReceberBaixaRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oRcBaixaRN.pesquisaBaixaCompensar(codempresa,
                                                                        empMaster,
        ...
        private void grdPsqCtaReceber_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.codempresa = codempresa;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqCtaReceber.Rows[grdPsqCtaReceber.CurrentRow.Index].Cells["idreceberbaixa"].Value.ToString());
