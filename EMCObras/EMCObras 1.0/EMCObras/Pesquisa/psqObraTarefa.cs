...
namespace EMCObras
{
    public partial class psqObraTarefa : Form
    {
        ...
        public psqObraTarefa()
        {
            InitializeComponent();
        }

          public psqObraTarefa(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
          ...
          private void btnPesquisa_Click(object sender, EventArgs e)
          {
              try
              {
                  Obra_TarefaRN oObraTarefaRN = new Obra_TarefaRN(Conexao, oOcorrencia, codempresa);

                  DataTable dtCon = oObraTarefaRN.pesquisaObraTarefa(empMaster, EmcResources.cInt(txtidObra_Tarefas.Text), txtTarefa.Text, EmcResources.cInt(txtidObra_Modulo.Text), txtModulo.Text);
                  grdObra_Tarefa.DataSource = dtCon;
          ...
          private void grdObra_Tarefa_DoubleClick(object sender, EventArgs e)
          {
              ...
              retPesquisa.chaveinterna = EmcResources.cInt(grdObra_Tarefa.Rows[grdObra_Tarefa.CurrentRow.Index].Cells["idobra_tarefas"].Value.ToString());
              this.Close();
          }

          private void psqObraTarefa_KeyDown(object sender, KeyEventArgs e)
          {
          ...
          private void psqObraTarefa_Load(object sender, EventArgs e)
          {
