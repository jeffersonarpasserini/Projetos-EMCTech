...
namespace EMCObras
{
    public partial class psqObraEtapa : Form
    {
        ...
        public psqObraEtapa(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdObra_Etapa_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdObra_Etapa.Rows[grdObra_Etapa.CurrentRow.Index].Cells["idobra_etapa"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Obra_EtapaRN oObraEtapaRN = new Obra_EtapaRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oObraEtapaRN.pesquisaObraEtapa(empMaster, EmcResources.cInt(txtidObra_Etapa.Text), txtDescricao.Text);
                
                grdObra_Etapa.DataSource = dtCon;
        ...
        private void psqObraEtapa_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqObraEtapa_Load(object sender, EventArgs e)
        {
