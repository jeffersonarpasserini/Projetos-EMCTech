...
namespace EMCObras
{
    public partial class psqObra : Form
    {
         ...
         public psqObra()
        {
         ...
         public psqObra(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
         ...
         private void grdObra_DoubleClick(object sender, EventArgs e)
         {
             ...
             retPesquisa.chaveinterna = EmcResources.cInt(grdObra.Rows[grdObra.CurrentRow.Index].Cells["idobra_cronograma"].Value.ToString());
             retPesquisa.chavebusca = grdObra.Rows[grdObra.CurrentRow.Index].Cells["abreviacao"].Value.ToString();
             this.Close();
         }
         ...
         private void btnPesquisa_Click(object sender, EventArgs e)
         {
             try
             {
                 Obra_CronogramaRN oObraCronogramaRN = new Obra_CronogramaRN(Conexao, oOcorrencia, codempresa);

                 DataTable dtCon = oObraCronogramaRN.pesquisaObra(empMaster, txtAbreviacao.Text, txtDescricaoObra.Text);
         ...
         private void psqObra_KeyDown(object sender, KeyEventArgs e)
         {
         ...
         private void psqObra_Load(object sender, EventArgs e)
         {
