...
namespace EMCObras
{
    public partial class psqObraModulo : Form
    {
        ...
        public psqObraModulo()
        {
            InitializeComponent();
        }

        public psqObraModulo(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Obra_ModuloRN oObraModuloRN = new Obra_ModuloRN(Conexao, oOcorrencia, codempresa);
               
                DataTable dtCon = oObraModuloRN.pesquisaObraModulo(empMaster, EmcResources.cInt(txtidObra_Modulo.Text), txtModulo.Text, EmcResources.cInt(txtidObra_Etapa.Text), txtEtapa.Text);
                grdObra_Modulo.DataSource = dtCon;
        ...
        private void grdObra_Modulo_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdObra_Modulo.Rows[grdObra_Modulo.CurrentRow.Index].Cells["idobra_modulo"].Value.ToString());
            this.Close();

        }

        private void psqObraModulo_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqObraModulo_Load(object sender, EventArgs e)
        {
