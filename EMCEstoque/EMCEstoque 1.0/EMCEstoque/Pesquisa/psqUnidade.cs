...
{
    public partial class psqProduto_Unidade : Form
    {
        ...
        public psqProduto_Unidade()
        {
            InitializeComponent();
        }

        public psqProduto_Unidade(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdPsqProduto_Unidade_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqProduto_Unidade.Rows[grdPsqProduto_Unidade.CurrentRow.Index].Cells["idestq_produto_unidade"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Estq_Produto_UnidadeRN oEstProdutoUnidadeRN = new Estq_Produto_UnidadeRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstProdutoUnidadeRN.pesquisaProdutoUnidade(empMaster, EmcResources.cInt(txtidEstq_Produto_Unidade.Text), txtDescricao.Text, txtUnidade_Abreviatura.Text);


                grdPsqProduto_Unidade.DataSource = dtCon;
        ...
        private void psqProduto_Unidade_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqProduto_Unidade_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtidEstq_Produto_Unidade;
        }
