...
{
    public partial class psqProduto : Form
    {
          ...
          public psqProduto()
        {
          ...
          public psqProduto(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
          ...
          private void grdPsqProduto_DoubleClick(object sender, EventArgs e)
          {
              retPesquisa.codempresa = empMaster;
              retPesquisa.chavebusca = grdPsqProduto.Rows[grdPsqProduto.CurrentRow.Index].Cells["codigoproduto"].Value.ToString();
              this.Close();
          }
          ...
          private void btnPesquisa_Click(object sender, EventArgs e)
          {
              try
              {
                  Estq_ProdutoRN oEstProdutoRN = new Estq_ProdutoRN(Conexao, oOcorrencia, codempresa);

                  DataTable dtCon = oEstProdutoRN.pesquisaProduto(empMaster, EmcResources.cInt(txtCodigoProduto.Text), txtProduto.Text);


                  grdPsqProduto.DataSource = dtCon;
          ...
          private void psqProduto_KeyDown(object sender, KeyEventArgs e)
          {
          ...
          private void psqProduto_Load(object sender, EventArgs e)
          {
