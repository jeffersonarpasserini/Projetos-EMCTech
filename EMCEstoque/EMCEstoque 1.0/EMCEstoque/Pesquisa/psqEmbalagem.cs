...
{
    public partial class psqEmbalagem : Form
    {
        ...
        public psqEmbalagem(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdPsqEmbalagem_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqEmbalagem.Rows[grdPsqEmbalagem.CurrentRow.Index].Cells["idestq_embalagem"].Value.ToString());
            this.Close();
        }

        private void psqEmbalagem_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqEmbalagem_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtIdEstq_Embalagem;
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Estq_EmbalagemRN oEstEmbalagemRN = new Estq_EmbalagemRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstEmbalagemRN.pesquisaEmbalagem(empMaster, EmcResources.cInt(txtIdEstq_Embalagem.Text), txtDescricao.Text);


                grdPsqEmbalagem.DataSource = dtCon;
