...
{
    public partial class psqGrupoEstoque : Form
    {
        ...
        public psqGrupoEstoque()
        {
            InitializeComponent();
        }

        public psqGrupoEstoque(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdEstq_Grupo_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdEstq_Grupo.Rows[grdEstq_Grupo.CurrentRow.Index].Cells["idEstq_grupo"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Estq_GrupoRN oEstqGrupoRN = new Estq_GrupoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstqGrupoRN.pesquisaGrupo(empMaster, EmcResources.cInt(txtidEstq_Grupo.Text), txtDescricao.Text);


                grdEstq_Grupo.DataSource = dtCon;
        ...
        private void psqGrupoEstoque_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqGrupoEstoque_Load(object sender, EventArgs e)
        {
