...
{
    public partial class psqTipoProduto : Form
    {
        ...
        public psqTipoProduto()
        {
            InitializeComponent();
        }

        public psqTipoProduto(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdEstq_TipoProduto_DoubleClick(object sender, EventArgs e)
        {
            ...
            retPesquisa.chaveinterna = EmcResources.cInt(grdEstq_TipoProduto.Rows[grdEstq_TipoProduto.CurrentRow.Index].Cells["idestq_tipoproduto"].Value.ToString());
            this.Close();
        }

        private void psqTipoProduto_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqTipoProduto_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtidEstq_TipoProduto;
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Estq_TipoProdutoRN oEstqTipoProdutoRN = new Estq_TipoProdutoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstqTipoProdutoRN.pesquisaTipoProduto(empMaster, EmcResources.cInt(txtidEstq_TipoProduto.Text), txtDescricao.Text);


                grdEstq_TipoProduto.DataSource = dtCon;
