...
{
    public partial class psqAlmoxarifado : Form
    {
        ...
        public psqAlmoxarifado()
        {
            InitializeComponent();
        }

        public psqAlmoxarifado(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
        ...
        private void grdPsqAlmoxarifado_DoubleClick(object sender, EventArgs e)
        {
            retPesquisa.codempresa = empMaster;
            retPesquisa.chaveinterna = EmcResources.cInt(grdPsqAlmoxarifado.Rows[grdPsqAlmoxarifado.CurrentRow.Index].Cells["idEstq_Almoxarifado"].Value.ToString());
            this.Close();
        }
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            try
            {
                Estq_AlmoxarifadoRN oEstAlmoxarifadoRN = new Estq_AlmoxarifadoRN(Conexao, oOcorrencia, codempresa);

                DataTable dtCon = oEstAlmoxarifadoRN.pesquisaAlmoxarifado(empMaster, EmcResources.cInt(txtidEstq_Almoxarifado.Text), txtDescricao.Text);


                grdPsqAlmoxarifado.DataSource = dtCon;
        ...
        private void psqAlmoxarifado_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void psqAlmoxarifado_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtidEstq_Almoxarifado;
        }
