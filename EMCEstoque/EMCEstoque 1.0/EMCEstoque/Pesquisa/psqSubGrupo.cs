...
{
    public partial class psqSubGrupo : Form
    {
         ...
         public psqSubGrupo()
        {
         ...
         public psqSubGrupo(String idUsuario, String seqLogin, String idEmpresa, String empmaster, ConectaBancoMySql pConexao, Ocorrencia pOcorrencia)
        {
            usuario = idUsuario;
            login = seqLogin;
         ...
         private void grdEstq_SubGrupo_DoubleClick(object sender, EventArgs e)
         {
             ...
             retPesquisa.chaveinterna = EmcResources.cInt(grdEstq_SubGrupo.Rows[grdEstq_SubGrupo.CurrentRow.Index].Cells["idEstq_subgrupo"].Value.ToString());
             this.Close();
         }
         ...
         private void btnPesquisa_Click(object sender, EventArgs e)
         {
             try
             {
                 Estq_SubGrupoRN oEstSubGrupoRN = new Estq_SubGrupoRN(Conexao, oOcorrencia, codempresa);

                 DataTable dtCon = oEstSubGrupoRN.pesquisaSubGrupo(empMaster, EmcResources.cInt(txtidEstq_SubGrupo.Text), txtDescricao.Text);


                 grdEstq_SubGrupo.DataSource = dtCon;
         ...
         private void psqSubGrupo_KeyDown(object sender, KeyEventArgs e)
         {
         ...
         private void psqSubGrupo_Load(object sender, EventArgs e)
         {
             ...
             this.ActiveControl = txtidEstq_SubGrupo;
         }
